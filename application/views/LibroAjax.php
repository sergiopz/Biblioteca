...
<div class="row container">
    <div class="col s12 m12 #536dfe indigo accent-2 z-depth-1 " id="capaAdmin">
       ...
       echo"</select></td>
        ...
        <td class='colorFila'><a class='btn-flat waves-effect waves-light #1e88e5 blue darken-1 white-text' href='".site_url("libros/showintadmin/$libro->id")."'><i class='material-icons' title='Subir páginas'>file_upload</i></a></td>
       <td class='colorFila'><a class='btn-flat waves-effect waves-light #1e88e5 blue darken-1 white-text' href='".site_url("libros/ModificarPaginas/$libro->id")."'><i class='material-icons' title='Subir páginas'>file_upload</i></a></td>
