...
<nav id="barrasuperior" class="navbar navbar-expand navbar-light">
      ...
      for ($i = 0; $i < count($listaBusqueda); $i++) {
          ...
          <div class='col-3'>
            <div class='card' style='width: 18rem;'>
              ...
              <a href='".site_url("Buscador/Visor/$bus->id")."'><img class='card-img-top'  src='".base_url("assets/libros/".$bus->id."/1.jpg")."' ></a>
