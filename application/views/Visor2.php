...
<html lang="en" class="no-js demo-1">
	...
	<body>
			...
			<div class="main clearfix">
				<div class="bb-custom-wrapper">
					...
					<div id="bb-bookblock" class="bb-bookblock">
						...
						<div class="bb-item" height="600" width="800">
						<img  class='pag2' src="2.jpg" alt="image02" height="300" width="400"/>
						</div>
						<div class="bb-item" >
						<img class='pag3' src="3.jpg" alt="image03" height="300" width="400"/>
						</div>
						<div class="bb-item">
		...
		<script>
				wheelzoom(document.querySelector('img.pag2'));
				
			</script>
			<script>
				wheelzoom(document.querySelector('img.pag3'));
			</script>
