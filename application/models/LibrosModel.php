...
class LibrosModel extends CI_Model
{
    ...
    //Funciones para ver los libros favoritos de un usuario
    public function getLibroFavorito($idUsuario)
    {
        $r = $this->db->query("SELECT * FROM `libros` lib inner join favoritos fav ON lib.id = fav.idLibro WHERE fav.idUsuario='$idUsuario'");
        $libros = array();
